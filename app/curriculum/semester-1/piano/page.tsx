...
const SECTIONS = [
  {
    ...
    desc: 'Piano setup, the six core drills, and how to use piano as secondary instrument.',
    weeks: 'Start here',
    color: '#0f172a',
  },
  {
    ...
    desc: 'Root position voicings, left-hand bass, blues shell chords, steady time.',
    weeks: 'Weeks 1–4',
    color: '#065f46',
  },
  {
    slug: 'month-2',
    title: 'Month 2: Vary',
    desc: 'New keys, expanded TPS colors, two-hand independence, jazz-blues vocabulary.',
    weeks: 'Weeks 5–8',
    color: '#92400e',
  },
  {
...
export default function PianoTrackHub() {
  return (
      ...
      <div className="py-10 px-4 sm:px-6" style={{ backgroundColor: '#0f172a' }}>
        <div className="max-w-4xl mx-auto">
          <p className="text-slate-400 text-sm mb-3">
            ...
            {' / '}
            <span className="text-slate-300">Piano Track</span>
          </p>
          <h1 className="text-white text-3xl sm:text-4xl font-bold mb-2">Piano Track</h1>
