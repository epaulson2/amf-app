...
// Exported so the practice plan page can embed this content in its Textbook tab.
  ...
  return (
    <article>
      ...
      <section id="part1">
        ...
        <P>Direction is not the same as pull intensity. Within each direction group, the pull varies considerably. Two components determine the quality of a pull: <strong>urgency</strong> (from pulsation rate — how pressingly the interval demands motion) and <strong>bond strength</strong> (from harmonicity — how acoustically rooted the relationship is). <BC>[1]</BC> and <BC>[5]</BC> both refer to the fundamental, but <BC>[1]</BC> pulls with acute urgency (8Hz) while <BC>[5]</BC> hangs calmly (2Hz). <BC>[3]</BC> and <BC>[4]</BC> share the same pulsation rate and direction, but <BC>[4]</BC>&apos;s harmonic bond gives its pull a sense of acoustic belonging — the notes are not just attracted, they are related. These differences in pull quality are as musically significant as direction itself.</P>
        <div className="my-4 border border-slate-200 rounded bg-slate-50 p-4">
          <p className="text-xs font-bold uppercase tracking-widest text-slate-500 mb-3">Pull Character by Direction Group</p>
          <div className="grid grid-cols-3 gap-4 text-xs">
            <div>
              <p className="font-bold text-slate-700 mb-2">← Toward Fundamental</p>
              <ul className="space-y-1 text-slate-600">
                <li><code className="font-mono font-bold text-slate-800">[1]</code> acute urgency</li>
                <li><code className="font-mono font-bold text-slate-800">[2]</code> urgent + rooted</li>
                <li><code className="font-mono font-bold text-slate-800">[3]</code> steady weight</li>
                <li><code className="font-mono font-bold text-slate-800">[4]</code> deep gravity</li>
                <li><code className="font-mono font-bold text-slate-800">[5]</code> calm suspension</li>
              </ul>
            </div>
            <div>
              <p className="font-bold text-slate-700 mb-2">← → Both</p>
              <ul className="space-y-1 text-slate-600">
                <li><code className="font-mono font-bold text-slate-800">[6]</code> no direction</li>
              </ul>
            </div>
            <div>
              <p className="font-bold text-slate-700 mb-2">→ Toward Octave</p>
              <ul className="space-y-1 text-slate-600">
                <li><code className="font-mono font-bold text-slate-800">[7]</code> deep stillness</li>
                <li><code className="font-mono font-bold text-slate-800">[8]</code> upward weight</li>
                <li><code className="font-mono font-bold text-slate-800">[9]</code> warm drift</li>
                <li><code className="font-mono font-bold text-slate-800">[10]</code> urgent + upward</li>
                <li><code className="font-mono font-bold text-slate-800">[11]</code> acute pressure</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <table className="w-full text-sm border-collapse">
            <thead>
              <tr className="bg-slate-100">
                ...
                <th className="px-3 py-2 border border-slate-200 text-left font-bold">Pull character</th>
              </tr>
            </thead>
            <tbody>
              {[
                ['[1]','dissonant','8Hz','fundamental','non-harmonic','dark','acute urgency'],
                ['[2]','dissonant','8Hz','fundamental','harmonic','light','urgent + rooted'],
                ['[3]','modal','4Hz','fundamental','non-harmonic','dark','steady weight'],
                ['[4]','modal','4Hz','fundamental','harmonic','light','deep gravity'],
                ['[5]','perfect','2Hz','fundamental','non-harmonic','dark','calm suspension'],
                ['[6]','perfect','2Hz','both','neutral','neutral','no direction'],
                ['[7]','perfect','2Hz','octave','harmonic','light','deep stillness'],
                ['[8]','modal','4Hz','octave','non-harmonic','dark','upward weight'],
                ['[9]','modal','4Hz','octave','false-harmonic','light','warm drift'],
                ['[10]','dissonant','8Hz','octave','harmonic','light','urgent + upward'],
                ['[11]','dissonant','8Hz','octave','non-harmonic','dark','acute pressure'],
              ].map(([dc, puls, rate, fo, harm, color, pull]) => (
                <tr key={dc} className="hover:bg-slate-50">
                  ...
                  <td className="px-3 py-2 border border-slate-200 italic text-slate-600">{pull}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        <P>This harmonic difference also changes the pull character. <BC>[3]</BC>&apos;s pull is <strong>steady weight</strong> — the notes are attracted to each other across a non-harmonic gap, dense and inward, like gravity pulling at something that has no acoustic reason to go except sheer attraction. <BC>[4]</BC>&apos;s pull is <strong>deep gravity</strong> — the acoustic kinship of the overtone series gives the pull a sense of belonging rather than mere attraction; the upper note is returning to its acoustic family. Both pull toward the fundamental at the same rate (4Hz). But one is tension seeking resolution; the other is kinship expressing itself. Train your ear to hear this texture beneath the direction — it is a different quality of downward, and it is musically essential.</P>
        ...
        <P>The Pictograph encodes direction (shadow) but not pull intensity. To read pull intensity, combine two factors already visible in the glyph: the wave shape gives urgency (jagged = 8Hz acute; smooth = 4Hz steady; flat = 2Hz calm) and the color gives bond strength (dark = non-harmonic, attraction across a gap; light = harmonic, acoustic kinship; neutral = ambivalent). A dark jagged di-chord like <BC>[1]</BC> has acute urgency with no acoustic bond — screaming pressure. A light flat di-chord like <BC>[7]</BC> has deep stillness with maximum acoustic kinship — the quietest and most rooted pull in the whole system. These pull readings are always latent in the Pictograph; they require reading two factors simultaneously rather than one.</P>
